                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <div class="position-relative has-icon-right">
                                <input type="text" id="exampleInputUsername" class="form-control input-shadow" value="{{ $Username }}" placeholder="Enter Username">
                        ...
                        <div class="form-group">
                            ...
                            <div class="position-relative has-icon-right">
                                <input type="password" id="exampleInputPassword" class="form-control input-shadow" value="{{ $Password }}" placeholder="Enter Password">
                                <div class="form-control-position">
                                    <i class="icon-lock"></i>
                                </div>
                            </div>
